...
export const AgregarPeliculas = () => {
  ...
  // Función para obtener los datos del formulario
   const agregarPeliculas = e =>{
    ...
    guardarPelis("pelis",listaPeliculas)
  ...
  return (
    <div className="add">
        ...
        <form onSubmit={agregarPeliculas}>
            <input type="text" id="title" name="titulo" placeholder="Titulo de la pelicula" />
            <textarea id="description" name='descripcion' placeholder="Descripción de la pelicula"></textarea>
