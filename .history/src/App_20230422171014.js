  ...
  return (
    ...
    <div className="layout">
        ...
        <section id="content" className="content">
         ...
         <ListadoPeliculas listadoPeliculasState={listadoPeliculasState} setListadoPeliculasState={setListadoPeliculasState}/>
        </section>

        {/*Barra lateral*/}
        <aside className="lateral">
           <BuscadorPeliculas/>
           <AgregarPeliculas setListadoPeliculasState={setListadoPeliculasState}/>
